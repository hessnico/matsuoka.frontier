...
Please Check the documentation for more information with `help(matsuoka3step)`.
...
```{r gam mat plot 3}
names(res$x) <- c("vet/cow", "energy/cow")
plot(res, ngrid = 300, counter_levels = 8,
     sub = "With 8 contour levels",
     ylab = "milk producde"
)
```
...
Really bad results, huh? Educational purposes...

...
pred_1 <- predict(res$g_hat$model, newdata = data.frame(x1 = x1, x2 = median(x2)), type = "response")
pred_2 <- predict(res$g_hat$model, newdata = data.frame(x1 = median(x1), x2 = x2), type = "response")
